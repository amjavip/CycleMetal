...
class OrderSerializer(serializers.ModelSerializer):
    ...
    id_collector = serializers.PrimaryKeyRelatedField(queryset=Collector.objects.all(), allow_null=True, required=False)

    class Meta:
        model = Order
        fields = ['id_order', 'id_seller', 'id_collector', 'orderCreationDay', 'items', 'status']
