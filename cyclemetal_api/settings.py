"""
Django settings for cyclemetal_api project.
...
ROOT_URLCONF = "cyclemetal_api.urls"
...
WSGI_APPLICATION = "cyclemetal_api.wsgi.application"
...
# Static files
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Carpeta donde pondrás tus archivos estáticos personalizados
]

STATIC_ROOT = (
    BASE_DIR / "staticfiles"
)  # Carpeta donde Django recogerá todos los static para producción
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://192.168.1.66",  # Tu IP local
    "http://10.0.2.2:8000",
    "http://localhost:8080",
    "http://127.0.0.1:5173",
    "http://192.168.155.194:8000",
